...
static const u8 LandmarkName_FlowerShop[] = _("BOTIGA FLORS");
static const u8 LandmarkName_PetalburgWoods[] = _("BOSC PETÀLIA");
static const u8 LandmarkName_MrBrineysCottage[] = _("CASA SR. ADRÍAN");
static const u8 LandmarkName_AbandonedShip[] = _("VAIXELL ABANDONAT");
static const u8 LandmarkName_SeashoreHouse[] = _("CASA DE COSTA");
static const u8 LandmarkName_SlateportBeach[] = _("PLATJA PORTUAL");
static const u8 LandmarkName_CyclingRoad[] = _("RUTA CICLISTA");
static const u8 LandmarkName_NewMauville[] = _("NOVA MALVALONA");
static const u8 LandmarkName_TrickHouse[] = _("CASA TRUC");
static const u8 LandmarkName_OldLadysRestShop[] = _("PARADA DE L'ÀVIA");
static const u8 LandmarkName_Desert[] = _("DESERT");
static const u8 LandmarkName_WinstrateFamily[] = _("FAMÍLIA VICTORIÓS");
static const u8 LandmarkName_CableCar[] = _("TELEFÈRIC");
static const u8 LandmarkName_GlassWorkshop[] = _("TALLER DE VIDRE");
static const u8 LandmarkName_WeatherInstitute[] = _("INST. METEO.");
static const u8 LandmarkName_MeteorFalls[] = _("CASCADES METEÒR");
static const u8 LandmarkName_TunnelersRestHouse[] = _("REFUGI MINAIRE");
static const u8 LandmarkName_RusturfTunnel[] = _("TÚNEL ROCASECA");
...
static const u8 LandmarkName_MtPyre[] = _("MT. PÍRA");
static const u8 LandmarkName_ShoalCave[] = _("COVA COSTA");
static const u8 LandmarkName_SeafloorCavern[] = _("COVA ABISAL");
static const u8 LandmarkName_GraniteCave[] = _("COVA GRANIT");
static const u8 LandmarkName_OceanCurrent[] = _("CORRENT OCEÀNIC");
static const u8 LandmarkName_LanettesHouse[] = _("CASA DE MAITE");
static const u8 LandmarkName_FieryPath[] = _("CAMÍ ARDENT");
static const u8 LandmarkName_JaggedPass[] = _("PAS ESCAPRAT");
static const u8 LandmarkName_SkyPillar[] = _("PILAR CEL");
static const u8 LandmarkName_BerryMastersHouse[] = _("CASA MESTRE BAIES");
static const u8 LandmarkName_IslandCave[] = _("COVA ILLA");
...
static const u8 LandmarkName_FossilManiacsHouse[] = _("CASA ARQUEÒLEG");
static const u8 LandmarkName_HuntersHouse[] = _("CASA CAÇADOR");
...
static const u8 LandmarkName_DesertUnderpass[] = _("TÚNEL DESERT");
