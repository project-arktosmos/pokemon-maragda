...
//.rodata
static const u8 sBerryDescriptionPart1_Cheri[] = _("Floreix amb flors boniques i delicades.");
static const u8 sBerryDescriptionPart2_Cheri[] = _("La BAIA vermella és molt picant.");
static const u8 sBerryDescriptionPart1_Chesto[] = _("La pell i la fruita de la BAIA són");
static const u8 sBerryDescriptionPart2_Chesto[] = _("molt dures. Té un gust sec pertot.");
static const u8 sBerryDescriptionPart1_Pecha[] = _("Molt dolça i deliciosa.");
static const u8 sBerryDescriptionPart2_Pecha[] = _("També molt tendra, manipular amb cura.");
static const u8 sBerryDescriptionPart1_Rawst[] = _("Si les fulles creixen llargues i rinxolades,");
static const u8 sBerryDescriptionPart2_Rawst[] = _("la BAIA sembla créixer molt amarga.");
static const u8 sBerryDescriptionPart1_Aspear[] = _("La BAIA dura és densa amb un suc");
static const u8 sBerryDescriptionPart2_Aspear[] = _("ric. És força àcida.");
static const u8 sBerryDescriptionPart1_Leppa[] = _("Creix més lent que CHERI i altres.");
static const u8 sBerryDescriptionPart2_Leppa[] = _("Com més petita la BAIA, més saborosa.");
static const u8 sBerryDescriptionPart1_Oran[] = _("Una BAIA peculiar amb barreja de sabors.");
static const u8 sBerryDescriptionPart2_Oran[] = _("Les BAIES creixen en mig dia.");
static const u8 sBerryDescriptionPart1_Persim[] = _("Li encanta la llum del sol. El color");
static const u8 sBerryDescriptionPart2_Persim[] = _("de la BAIA es fa vívid amb el sol.");
static const u8 sBerryDescriptionPart1_Lum[] = _("Lenta per créixer. Si es cria amb");
static const u8 sBerryDescriptionPart2_Lum[] = _("afecte, pot fer dues BAIES.");
static const u8 sBerryDescriptionPart1_Sitrus[] = _("Relacionada amb ORAN. La gran");
static const u8 sBerryDescriptionPart2_Sitrus[] = _("BAIA té un sabor equilibrat.");
static const u8 sBerryDescriptionPart1_Figy[] = _("La BAIA, que sembla mossegada,");
static const u8 sBerryDescriptionPart2_Figy[] = _("està plena de substàncies picants.");
static const u8 sBerryDescriptionPart1_Wiki[] = _("Es diu que la BAIA ha crescut grumollosa");
static const u8 sBerryDescriptionPart2_Wiki[] = _("per ajudar els POKéMON a agafar-la.");
static const u8 sBerryDescriptionPart1_Mago[] = _("La BAIA es fa corba mentre creix.");
static const u8 sBerryDescriptionPart2_Mago[] = _("Com més corba, més dolça i saborosa.");
static const u8 sBerryDescriptionPart1_Aguav[] = _("La flor és delicada. És rara per la seva");
static const u8 sBerryDescriptionPart2_Aguav[] = _("capacitat de créixer sense llum.");
...
static const u8 sBerryDescriptionPart1_Razz[] = _("La BAIA vermella té gust lleugerament picant.");
...
static const u8 sBerryDescriptionPart2_Bluk[] = _("ennegreix la boca quan es menja.");
...
static const u8 sBerryDescriptionPart1_Kelpsy[] = _("Una varietat rara amb forma d'arrel.");
static const u8 sBerryDescriptionPart2_Kelpsy[] = _("Fa créixer una flor molt gran.");
static const u8 sBerryDescriptionPart1_Qualot[] = _("Li encanta l'aigua. Creix fort fins i tot");
static const u8 sBerryDescriptionPart2_Qualot[] = _("en llocs amb pluja constant.");
static const u8 sBerryDescriptionPart1_Hondew[] = _("Una BAIA molt valuosa i");
static const u8 sBerryDescriptionPart2_Hondew[] = _("poc vista. És molt deliciosa.");
static const u8 sBerryDescriptionPart1_Grepa[] = _("Malgrat la seva tendresa i forma");
static const u8 sBerryDescriptionPart2_Grepa[] = _("rodona, la BAIA és molt àcida.");
static const u8 sBerryDescriptionPart1_Tamato[] = _("La BAIA és extremadament picant.");
...
static const u8 sBerryDescriptionPart1_Magost[] = _("Una BAIA de la qual es diu àmpliament");
static const u8 sBerryDescriptionPart2_Magost[] = _("que té un sabor finament equilibrat.");
static const u8 sBerryDescriptionPart1_Rabuta[] = _("Una varietat rara coberta de");
static const u8 sBerryDescriptionPart2_Rabuta[] = _("pèls. És força amarga.");
static const u8 sBerryDescriptionPart1_Nomel[] = _("Força àcida. Una mossegada fa");
static const u8 sBerryDescriptionPart2_Nomel[] = _("impossible tastar res per tres dies.");
static const u8 sBerryDescriptionPart1_Spelon[] = _("La BAIA vermella viva és molt picant.");
static const u8 sBerryDescriptionPart2_Spelon[] = _("Les berrugues secreten substància picant.");
static const u8 sBerryDescriptionPart1_Pamtre[] = _("Deriva pel mar des d'algun lloc.");
static const u8 sBerryDescriptionPart2_Pamtre[] = _("Es creu que creix en un altre lloc.");
static const u8 sBerryDescriptionPart1_Watmel[] = _("Una BAIA enorme, amb algunes de més");
static const u8 sBerryDescriptionPart2_Watmel[] = _("de 50 cm. Extremadament dolça.");
static const u8 sBerryDescriptionPart1_Durin[] = _("Amarga només de mirar-la. És tan");
static const u8 sBerryDescriptionPart2_Durin[] = _("amarga que ningú l'ha menjat sola.");
static const u8 sBerryDescriptionPart1_Belue[] = _("És brillant i sembla deliciosa, però");
static const u8 sBerryDescriptionPart2_Belue[] = _("és terriblement àcida. Triga a créixer.");
static const u8 sBerryDescriptionPart1_Liechi[] = _("Una BAIA misteriosa. Es rumoreja que");
static const u8 sBerryDescriptionPart2_Liechi[] = _("conté el poder del mar.");
static const u8 sBerryDescriptionPart1_Ganlon[] = _("Una BAIA misteriosa. Es rumoreja que");
static const u8 sBerryDescriptionPart2_Ganlon[] = _("conté el poder de la terra.");
static const u8 sBerryDescriptionPart1_Salac[] = _("Una BAIA misteriosa. Es rumoreja que");
static const u8 sBerryDescriptionPart2_Salac[] = _("conté el poder del cel.");
static const u8 sBerryDescriptionPart1_Petaya[] = _("Una BAIA misteriosa. Es rumoreja que");
static const u8 sBerryDescriptionPart2_Petaya[] = _("conté el poder de tots els éssers vius.");
static const u8 sBerryDescriptionPart1_Apicot[] = _("Una BAIA molt misteriosa. No se sap");
static const u8 sBerryDescriptionPart2_Apicot[] = _("què pot passar o com pot usar-se.");
static const u8 sBerryDescriptionPart1_Lansat[] = _("Es diu que és una BAIA llegendària.");
static const u8 sBerryDescriptionPart2_Lansat[] = _("Portar-la suposadament dóna alegria.");
static const u8 sBerryDescriptionPart1_Starf[] = _("Tan forta que va ser abandonada a la");
static const u8 sBerryDescriptionPart2_Starf[] = _("fi del món. Considerada un miratge.");
static const u8 sBerryDescriptionPart1_Enigma[] = _("Una BAIA completament enigmàtica.");
static const u8 sBerryDescriptionPart2_Enigma[] = _("Sembla tenir el poder de les estrelles.");
