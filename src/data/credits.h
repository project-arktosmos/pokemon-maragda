...
static const u8 sCreditsText_PkmnEmeraldVersion[]             = _("POKéMON VERSIÓ MARAGDA");
static const u8 sCreditsText_Credits[]                        = _("Crèdits");
static const u8 sCreditsText_ExecutiveDirector[]              = _("Director Executiu");
static const u8 sCreditsText_Director[]                       = _("Director");
static const u8 sCreditsText_ArtDirector[]                    = _("Director Artístic");
static const u8 sCreditsText_BattleDirector[]                 = _("Director de Combat");
static const u8 sCreditsText_MainProgrammer[]                 = _("Programador Principal");
static const u8 sCreditsText_BattleSystemPgrms[]              = _("Programadors Sistema Combat");
static const u8 sCreditsText_FieldSystemPgrms[]               = _("Programador Sistema Camp");
static const u8 sCreditsText_Programmers[]                    = _("Programadors");
static const u8 sCreditsText_MainGraphicDesigner[]            = _("Dissenyador Gràfic Principal");
static const u8 sCreditsText_GraphicDesigners[]               = _("Dissenyadors Gràfics");
static const u8 sCreditsText_PkmnDesigners[]                  = _("Dissenyadors POKéMON");
static const u8 sCreditsText_MusicComposition[]               = _("Composició Musical");
static const u8 sCreditsText_SoundEffectsAndPkmnVoices[]      = _("Efectes Sonors i Veus POKéMON");
static const u8 sCreditsText_GameDesigners[]                  = _("Dissenyadors de Joc");
static const u8 sCreditsText_ScenarioPlot[]                   = _("Argument");
static const u8 sCreditsText_Scenario[]                       = _("Escenari");
static const u8 sCreditsText_ScriptDesigners[]                = _("Dissenyadors de Guió");
static const u8 sCreditsText_MapDesigners[]                   = _("Dissenyadors de Mapes");
static const u8 sCreditsText_MapDataDesigners[]               = _("Dissenyadors Dades Mapes");
static const u8 sCreditsText_ParametricDesigners[]            = _("Dissenyadors Paramètrics");
static const u8 sCreditsText_PokedexText[]                    = _("Text POKéDEX");
static const u8 sCreditsText_EnvAndToolPgrms[]                = _("Programadors Entorn i Eines");
static const u8 sCreditsText_NCLProductTesting[]              = _("Proves de Producte NCL");
static const u8 sCreditsText_SpecialThanks[]                  = _("Agraïments Especials");
static const u8 sCreditsText_Coordinators[]                   = _("Coordinadors");
static const u8 sCreditsText_Producers[]                      = _("Productors");
static const u8 sCreditsText_ExecProducers[]                  = _("Productors Executius");
static const u8 sCreditsText_InfoSupervisors[]                = _("Supervisors d'Informació");
static const u8 sCreditsText_TaskManagers[]                   = _("Gestors de Tasques");
static const u8 sCreditsText_BrailleCodeCheck[]               = _("Verificació Codi Braille");
static const u8 sCreditsText_WorldDirector[]                  = _("Director de Món");
static const u8 sCreditsText_BattleFrontierData[]             = _("Dades Zona Combat");
static const u8 sCreditsText_SupportProgrammers[]             = _("Programadors de Suport");
static const u8 sCreditsText_Artwork[]                        = _("Art");
static const u8 sCreditsText_LeadProgrammer[]                 = _("Programador en Cap");
static const u8 sCreditsText_LeadGraphicArtist[]              = _("Artista Gràfic en Cap");
...
static const u8 sCreditsText_PackageAndManual[]               = _("Il·lustració Capsa i Manual");
static const u8 sCreditsText_EnglishVersion[]                 = _("Coordinadors Versió Anglesa");
static const u8 sCreditsText_Translator[]                     = _("Traductor");
static const u8 sCreditsText_TextEditor[]                     = _("Editor de Text");
static const u8 sCreditsText_NCLCoordinator[]                 = _("Coordinador NCL");
static const u8 sCreditsText_GraphicDesigner[]                = _("Dissenyador Gràfic");
static const u8 sCreditsText_NOAProductTesting[]              = _("Proves de Producte NOA");
