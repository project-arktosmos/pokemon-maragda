const u8 gEasyChatWord_IChooseYou[] = _("ET TRIO A TU");
const u8 gEasyChatWord_Gotcha[] = _("T'HE ATRAPAT");
const u8 gEasyChatWord_Trade[] = _("INTERCANVI");
const u8 gEasyChatWord_Sapphire[] = _("SAFIR");
const u8 gEasyChatWord_Evolve[] = _("EVOLUCIONAR");
const u8 gEasyChatWord_Encyclopedia[] = _("ENCICLOPÈDIA");
const u8 gEasyChatWord_Nature[] = _("NATURA");
const u8 gEasyChatWord_Center[] = _("CENTRE");
const u8 gEasyChatWord_Egg[] = _("OU");
const u8 gEasyChatWord_Link[] = _("ENLLAÇ");
const u8 gEasyChatWord_SpAbility[] = _("HABILITAT");
const u8 gEasyChatWord_Trainer[] = _("ENTRENADOR");
const u8 gEasyChatWord_Version[] = _("VERSIÓ");
...
const u8 gEasyChatWord_Ruby[] = _("ROBÍ");
const u8 gEasyChatWord_Level[] = _("NIVELL");
const u8 gEasyChatWord_Red[] = _("VERMELL");
const u8 gEasyChatWord_Green[] = _("VERD");
const u8 gEasyChatWord_Bag[] = _("BOSSA");
const u8 gEasyChatWord_Flame[] = _("FLAMA");
const u8 gEasyChatWord_Gold[] = _("OR");
const u8 gEasyChatWord_Leaf[] = _("FULLA");
const u8 gEasyChatWord_Silver[] = _("PLATA");
const u8 gEasyChatWord_Emerald[] = _("MARAGDA");
