const u8 gEasyChatWord_Fall[] = _("TARDOR");
const u8 gEasyChatWord_Morning[] = _("MATÍ");
const u8 gEasyChatWord_Tomorrow[] = _("DEMÀ");
const u8 gEasyChatWord_Last[] = _("ÚLTIM");
const u8 gEasyChatWord_Day[] = _("DIA");
const u8 gEasyChatWord_Sometime[] = _("ALGUN DIA");
const u8 gEasyChatWord_Always[] = _("SEMPRE");
const u8 gEasyChatWord_Current[] = _("ACTUAL");
const u8 gEasyChatWord_Forever[] = _("PER SEMPRE");
const u8 gEasyChatWord_Days[] = _("DIES");
const u8 gEasyChatWord_End[] = _("FINAL");
const u8 gEasyChatWord_Tuesday[] = _("DIMARTS");
const u8 gEasyChatWord_Yesterday[] = _("AHIR");
const u8 gEasyChatWord_Today[] = _("AVUI");
const u8 gEasyChatWord_Friday[] = _("DIVENDRES");
const u8 gEasyChatWord_Monday[] = _("DILLUNS");
const u8 gEasyChatWord_Later[] = _("MÉS TARD");
const u8 gEasyChatWord_Earlier[] = _("ABANS");
const u8 gEasyChatWord_Another[] = _("UN ALTRE");
const u8 gEasyChatWord_Time[] = _("TEMPS");
const u8 gEasyChatWord_Finish[] = _("ACABAR");
const u8 gEasyChatWord_Wednesday[] = _("DIMECRES");
const u8 gEasyChatWord_Soon[] = _("AVIAT");
const u8 gEasyChatWord_Start[] = _("COMENÇAR");
const u8 gEasyChatWord_Month[] = _("MES");
const u8 gEasyChatWord_Stop[] = _("PARAR");
const u8 gEasyChatWord_Now[] = _("ARA");
const u8 gEasyChatWord_Final[] = _("FINAL");
const u8 gEasyChatWord_Next[] = _("SEGÜENT");
const u8 gEasyChatWord_Age[] = _("EDAT");
const u8 gEasyChatWord_Saturday[] = _("DISSABTE");
const u8 gEasyChatWord_Summer[] = _("ESTIU");
const u8 gEasyChatWord_Sunday[] = _("DIUMENGE");
const u8 gEasyChatWord_Beginning[] = _("INICI");
const u8 gEasyChatWord_Spring[] = _("PRIMAVERA");
const u8 gEasyChatWord_Daytime[] = _("DE DIA");
const u8 gEasyChatWord_Winter[] = _("HIVERN");
const u8 gEasyChatWord_Daily[] = _("DIARI");
const u8 gEasyChatWord_Olden[] = _("ANTIC");
const u8 gEasyChatWord_Almost[] = _("GAIREBÉ");
const u8 gEasyChatWord_Nearly[] = _("QUASI");
const u8 gEasyChatWord_Thursday[] = _("DIJOUS");
const u8 gEasyChatWord_Nighttime[] = _("DE NIT");
const u8 gEasyChatWord_Night[] = _("NIT");
const u8 gEasyChatWord_Week[] = _("SETMANA");
