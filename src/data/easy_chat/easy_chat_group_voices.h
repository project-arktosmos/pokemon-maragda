...
const u8 gEasyChatWord_Eek[] = _("AH");
const u8 gEasyChatWord_Graaah[] = _("GRAAAH");
const u8 gEasyChatWord_Gwahahaha[] = _("GWAHAHAHA");
const u8 gEasyChatWord_Way[] = _("VA");
const u8 gEasyChatWord_Tch[] = _("TSK");
...
const u8 gEasyChatWord_Aiyeeh[] = _("AI AI");
const u8 gEasyChatWord_Hiyah[] = _("HIYA");
const u8 gEasyChatWord_Fufufu[] = _("FUFUFU");
const u8 gEasyChatWord_Lol[] = _("LOL");
const u8 gEasyChatWord_Snort[] = _("PFFF");
const u8 gEasyChatWord_Humph[] = _("BUF");
const u8 gEasyChatWord_Hehehe[] = _("HEHEHE");
const u8 gEasyChatWord_Heh[] = _("HE");
const u8 gEasyChatWord_Hohoho[] = _("HOHOHO");
const u8 gEasyChatWord_UhHuh[] = _("AJAM");
const u8 gEasyChatWord_OhDear[] = _("VAJA");
const u8 gEasyChatWord_Arrgh[] = _("ARGH");
const u8 gEasyChatWord_Mufufu[] = _("MUFUFU");
const u8 gEasyChatWord_Mmm[] = _("MMM");
const u8 gEasyChatWord_OhKay[] = _("D'ACORD");
const u8 gEasyChatWord_Okay[] = _("ENTESOS");
const u8 gEasyChatWord_Lalala[] = _("LALALA");
const u8 gEasyChatWord_Yay[] = _("BÉ!");
const u8 gEasyChatWord_Aww[] = _("OH");
const u8 gEasyChatWord_Wowee[] = _("UAUU");
