const u8 gEasyChatWord_MatchUp[] = _("ENFRONTAR");
const u8 gEasyChatWord_Go[] = _("ENDAVANT");
const u8 gEasyChatWord_No1[] = _("Nº 1");
const u8 gEasyChatWord_Decide[] = _("DECIDIR");
const u8 gEasyChatWord_LetMeWin[] = _("DEIXA'M");
const u8 gEasyChatWord_Wins[] = _("GUANYA");
const u8 gEasyChatWord_Win[] = _("GUANYAR");
const u8 gEasyChatWord_Won[] = _("GUANYAT");
const u8 gEasyChatWord_IfIWin[] = _("SI GUANYO");
const u8 gEasyChatWord_WhenIWin[] = _("QUAN GUANYI");
const u8 gEasyChatWord_CantWin[] = _("NO PUC");
const u8 gEasyChatWord_CanWin[] = _("PUC GUANYAR");
const u8 gEasyChatWord_NoMatch[] = _("CAP RIVAL");
const u8 gEasyChatWord_Spirit[] = _("ESPERIT");
const u8 gEasyChatWord_Decided[] = _("DECIDIT");
const u8 gEasyChatWord_TrumpCard[] = _("CARTA SECR");
const u8 gEasyChatWord_TakeThat[] = _("PREN AIXÒ");
const u8 gEasyChatWord_ComeOn[] = _("VINGA");
const u8 gEasyChatWord_Attack[] = _("ATAC");
const u8 gEasyChatWord_Surrender[] = _("RENDIR-SE");
const u8 gEasyChatWord_Gutsy[] = _("VALENT");
const u8 gEasyChatWord_Talent[] = _("TALENT");
const u8 gEasyChatWord_Strategy[] = _("ESTRATÈGIA");
const u8 gEasyChatWord_Smite[] = _("CASTIGAR");
const u8 gEasyChatWord_Match[] = _("PARTIT");
const u8 gEasyChatWord_Victory[] = _("VICTÒRIA");
const u8 gEasyChatWord_Offensive[] = _("OFENSIVA");
const u8 gEasyChatWord_Sense[] = _("SENTIT");
const u8 gEasyChatWord_Versus[] = _("CONTRA");
const u8 gEasyChatWord_Fights[] = _("LLUITA");
const u8 gEasyChatWord_Power[] = _("PODER");
const u8 gEasyChatWord_Challenge[] = _("REPTE");
const u8 gEasyChatWord_Strong[] = _("FORT");
const u8 gEasyChatWord_TooStrong[] = _("MASSA FORT");
const u8 gEasyChatWord_GoEasy[] = _("SUAU");
const u8 gEasyChatWord_Foe[] = _("ENEMIC");
const u8 gEasyChatWord_Genius[] = _("GENI");
const u8 gEasyChatWord_Legend[] = _("LLEGENDA");
const u8 gEasyChatWord_Escape[] = _("ESCAPAR");
const u8 gEasyChatWord_Aim[] = _("OBJECTIU");
const u8 gEasyChatWord_Battle[] = _("BATALLA");
const u8 gEasyChatWord_Fight[] = _("LLUITAR");
const u8 gEasyChatWord_Resuscitate[] = _("RESSUSCITAR");
const u8 gEasyChatWord_Points[] = _("PUNTS");
const u8 gEasyChatWord_Serious[] = _("SERIÓS");
const u8 gEasyChatWord_GiveUp[] = _("ABANDONAR");
const u8 gEasyChatWord_Loss[] = _("PÈRDUA");
const u8 gEasyChatWord_IfILose[] = _("SI PERDO");
const u8 gEasyChatWord_Lost[] = _("PERDUT");
const u8 gEasyChatWord_Lose[] = _("PERDRE");
const u8 gEasyChatWord_Guard[] = _("GUÀRDIA");
const u8 gEasyChatWord_Partner[] = _("COMPANY");
const u8 gEasyChatWord_Reject[] = _("REBUTJAR");
const u8 gEasyChatWord_Accept[] = _("ACCEPTAR");
const u8 gEasyChatWord_Invincible[] = _("INVENCIBLE");
const u8 gEasyChatWord_Received[] = _("REBUT");
const u8 gEasyChatWord_Easy[] = _("FÀCIL");
const u8 gEasyChatWord_Weak[] = _("FEBLE");
const u8 gEasyChatWord_TooWeak[] = _("MASSA FEBLE");
const u8 gEasyChatWord_Pushover[] = _("BUFAR I FER");
const u8 gEasyChatWord_Leader[] = _("LÍDER");
const u8 gEasyChatWord_Rule[] = _("REGLA");
const u8 gEasyChatWord_Move[] = _("MOVIMENT");
