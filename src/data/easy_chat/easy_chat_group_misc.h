...
const u8 gEasyChatWord_Below[] = _("SOTA");
const u8 gEasyChatWord_Above[] = _("SOBRE");
...
const u8 gEasyChatWord_TheseWere[] = _("EREN");
const u8 gEasyChatWord_Down[] = _("AVALL");
const u8 gEasyChatWord_That[] = _("ALLÒ");
const u8 gEasyChatWord_ThoseAre[] = _("AQUELLS SÓN");
const u8 gEasyChatWord_ThoseWere[] = _("EREN");
const u8 gEasyChatWord_ThatsItExcl[] = _("AIXÒ ÉS!");
const u8 gEasyChatWord_Am[] = _("SÓC");
...
const u8 gEasyChatWord_Away[] = _("FORA");
...
const u8 gEasyChatWord_Shallow[] = _("SUPERFICIAL");
