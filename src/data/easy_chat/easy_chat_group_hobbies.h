const u8 gEasyChatWord_Idol[] = _("ÍDOL");
const u8 gEasyChatWord_Anime[] = _("ANIME");
const u8 gEasyChatWord_Song[] = _("CANÇÓ");
const u8 gEasyChatWord_Movie[] = _("PEL·LÍCULA");
const u8 gEasyChatWord_Sweets[] = _("DOLÇOS");
const u8 gEasyChatWord_Chat[] = _("XERRAR");
const u8 gEasyChatWord_ChildsPlay[] = _("JOC NENS");
const u8 gEasyChatWord_Toys[] = _("JOGUINES");
const u8 gEasyChatWord_Music[] = _("MÚSICA");
const u8 gEasyChatWord_Cards[] = _("CARTES");
const u8 gEasyChatWord_Shopping[] = _("COMPRES");
const u8 gEasyChatWord_Camera[] = _("CÀMERA");
const u8 gEasyChatWord_Viewing[] = _("MIRANT");
const u8 gEasyChatWord_Spectator[] = _("ESPECTADOR");
const u8 gEasyChatWord_Gourmet[] = _("GOURMET");
const u8 gEasyChatWord_Game[] = _("JOC");
const u8 gEasyChatWord_Rpg[] = _("RPG");
const u8 gEasyChatWord_Collection[] = _("COL·LECCIÓ");
const u8 gEasyChatWord_Complete[] = _("COMPLET");
const u8 gEasyChatWord_Magazine[] = _("REVISTA");
const u8 gEasyChatWord_Walk[] = _("PASSEJAR");
const u8 gEasyChatWord_Bike[] = _("BICI");
const u8 gEasyChatWord_Hobby[] = _("AFICIÓ");
const u8 gEasyChatWord_Sports[] = _("ESPORTS");
const u8 gEasyChatWord_Software[] = _("SOFTWARE");
const u8 gEasyChatWord_Songs[] = _("CANÇONS");
const u8 gEasyChatWord_Diet[] = _("DIETA");
const u8 gEasyChatWord_Treasure[] = _("TRESOR");
const u8 gEasyChatWord_Travel[] = _("VIATJAR");
const u8 gEasyChatWord_Dance[] = _("BALLAR");
const u8 gEasyChatWord_Channel[] = _("CANAL");
const u8 gEasyChatWord_Making[] = _("FER");
const u8 gEasyChatWord_Fishing[] = _("PESCAR");
const u8 gEasyChatWord_Date[] = _("CITA");
const u8 gEasyChatWord_Design[] = _("DISSENY");
const u8 gEasyChatWord_Locomotive[] = _("LOCOMOTORA");
const u8 gEasyChatWord_PlushDoll[] = _("PELUIX");
const u8 gEasyChatWord_Pc[] = _("PC");
const u8 gEasyChatWord_Flowers[] = _("FLORS");
const u8 gEasyChatWord_Hero[] = _("HEROI");
const u8 gEasyChatWord_Nap[] = _("MIGDIADA");
const u8 gEasyChatWord_Heroine[] = _("HEROÏNA");
const u8 gEasyChatWord_Fashion[] = _("MODA");
const u8 gEasyChatWord_Adventure[] = _("AVENTURA");
const u8 gEasyChatWord_Board[] = _("TAULER");
const u8 gEasyChatWord_Ball[] = _("PILOTA");
const u8 gEasyChatWord_Book[] = _("LLIBRE");
const u8 gEasyChatWord_Festival[] = _("FESTIVAL");
const u8 gEasyChatWord_Comics[] = _("CÒMICS");
const u8 gEasyChatWord_Holiday[] = _("FESTIU");
const u8 gEasyChatWord_Plans[] = _("PLANS");
const u8 gEasyChatWord_Trendy[] = _("DE MODA");
const u8 gEasyChatWord_Vacation[] = _("VACANCES");
const u8 gEasyChatWord_Look[] = _("MIRAR");
