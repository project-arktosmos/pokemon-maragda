const u8 gEasyChatWord_Meets[] = _("TROBA");
const u8 gEasyChatWord_Concede[] = _("CONCEDIR");
const u8 gEasyChatWord_Give[] = _("DONAR");
const u8 gEasyChatWord_Gives[] = _("DÓNA");
const u8 gEasyChatWord_Played[] = _("JUGAT");
const u8 gEasyChatWord_Plays[] = _("JUGA");
const u8 gEasyChatWord_Collect[] = _("RECOLLIR");
const u8 gEasyChatWord_Walking[] = _("CAMINANT");
const u8 gEasyChatWord_Walks[] = _("CAMINA");
const u8 gEasyChatWord_Says[] = _("DIU");
const u8 gEasyChatWord_Went[] = _("VAIG ANAR");
const u8 gEasyChatWord_Said[] = _("VA DIR");
const u8 gEasyChatWord_WakeUp[] = _("DESPERTAR");
const u8 gEasyChatWord_WakesUp[] = _("ES DESPERTA");
const u8 gEasyChatWord_Angers[] = _("ENFADA");
const u8 gEasyChatWord_Teach[] = _("ENSENYAR");
const u8 gEasyChatWord_Teaches[] = _("ENSENYA");
const u8 gEasyChatWord_Please[] = _("SI US PLAU");
const u8 gEasyChatWord_Learn[] = _("APRENDRE");
const u8 gEasyChatWord_Change[] = _("CANVIAR");
const u8 gEasyChatWord_Story[] = _("HISTÒRIA");
const u8 gEasyChatWord_Trust[] = _("CONFIAR");
const u8 gEasyChatWord_Lavish[] = _("GENERÓS");
const u8 gEasyChatWord_Listens[] = _("ESCOLTA");
const u8 gEasyChatWord_Hearing[] = _("ESCOLTANT");
const u8 gEasyChatWord_Trains[] = _("ENTRENA");
const u8 gEasyChatWord_Choose[] = _("TRIAR");
const u8 gEasyChatWord_Come[] = _("VENIR");
const u8 gEasyChatWord_Came[] = _("VA VENIR");
const u8 gEasyChatWord_Search[] = _("BUSCAR");
const u8 gEasyChatWord_Make[] = _("FER");
const u8 gEasyChatWord_Cause[] = _("CAUSAR");
const u8 gEasyChatWord_Know[] = _("SABER");
const u8 gEasyChatWord_Knows[] = _("SAP");
const u8 gEasyChatWord_Refuse[] = _("REFUSAR");
const u8 gEasyChatWord_Stores[] = _("GUARDA");
const u8 gEasyChatWord_Brag[] = _("PRESUMIR");
const u8 gEasyChatWord_Ignorant[] = _("IGNORANT");
const u8 gEasyChatWord_Thinks[] = _("PENSA");
const u8 gEasyChatWord_Believe[] = _("CREURE");
const u8 gEasyChatWord_Slide[] = _("LLISCAR");
const u8 gEasyChatWord_Eats[] = _("MENJA");
const u8 gEasyChatWord_Use[] = _("USAR");
const u8 gEasyChatWord_Uses[] = _("USA");
const u8 gEasyChatWord_Using[] = _("USANT");
const u8 gEasyChatWord_Couldnt[] = _("NO PODIA");
const u8 gEasyChatWord_Capable[] = _("CAPAÇ");
const u8 gEasyChatWord_Disappear[] = _("DESAPARÈIX");
const u8 gEasyChatWord_Appear[] = _("APARÈIXER");
const u8 gEasyChatWord_Throw[] = _("LLENÇAR");
const u8 gEasyChatWord_Worry[] = _("PREOCUPAR");
const u8 gEasyChatWord_Slept[] = _("DORMIT");
const u8 gEasyChatWord_Sleep[] = _("DORMIR");
const u8 gEasyChatWord_Release[] = _("ALLIBERAR");
const u8 gEasyChatWord_Drinks[] = _("BEU");
const u8 gEasyChatWord_Runs[] = _("CORRE");
const u8 gEasyChatWord_Run[] = _("CÓRRER");
const u8 gEasyChatWord_Works[] = _("TREBALLA");
const u8 gEasyChatWord_Working[] = _("TREBALLANT");
const u8 gEasyChatWord_Talking[] = _("PARLANT");
const u8 gEasyChatWord_Talk[] = _("PARLAR");
const u8 gEasyChatWord_Sink[] = _("ENFONSAR");
const u8 gEasyChatWord_Smack[] = _("BUFETADA");
const u8 gEasyChatWord_Pretend[] = _("FINGIR");
const u8 gEasyChatWord_Praise[] = _("LLOAR");
const u8 gEasyChatWord_Overdo[] = _("EXAGERAR");
const u8 gEasyChatWord_Show[] = _("MOSTRAR");
const u8 gEasyChatWord_Looks[] = _("SEMBLA");
const u8 gEasyChatWord_Sees[] = _("VEU");
const u8 gEasyChatWord_Seek[] = _("CERCAR");
const u8 gEasyChatWord_Own[] = _("PROPI");
const u8 gEasyChatWord_Take[] = _("AGAFAR");
const u8 gEasyChatWord_Allow[] = _("PERMETRE");
const u8 gEasyChatWord_Forget[] = _("OBLIDAR");
const u8 gEasyChatWord_Forgets[] = _("OBLIDA");
const u8 gEasyChatWord_Appears[] = _("APAREIX");
const u8 gEasyChatWord_Faint[] = _("DESMAIAR");
const u8 gEasyChatWord_Fainted[] = _("DESMAIAT");
