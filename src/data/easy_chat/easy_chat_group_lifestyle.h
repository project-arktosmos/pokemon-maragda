...
const u8 gEasyChatWord_Habit[] = _("HÀBIT");
...
const u8 gEasyChatWord_Living[] = _("VIURE");
const u8 gEasyChatWord_Teacher[] = _("PROFESSOR");
...
const u8 gEasyChatWord_Test[] = _("EXAMEN");
const u8 gEasyChatWord_DeptStore[] = _("GRANS MAGAT.");
...
const u8 gEasyChatWord_Kindergarten[] = _("GUARDERIA");
