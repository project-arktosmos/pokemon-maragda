...
static const u8 sText_SpaceMove[] = _(" MOVIMENT"); // unused
...
static const u8 sText_IsThisTradeOkay[] = _("Està bé aquest intercanvi?");
static const u8 sText_Cancel[] = _("CANCEL·LAR");
static const u8 sText_ChooseAPkmn[] = _("Escull un POKéMON.");
...
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}En espera de comunicació…\nSi us plau, espera.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}L'intercanvi s'ha\ncancel·lat.");
static const u8 sText_OnlyPkmnForBattle[] = _("Aquest és el teu únic\nPOKéMON per combatre.");
