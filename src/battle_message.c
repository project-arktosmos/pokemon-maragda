...
static const u8 sText_ABoosted[] = _(" potenciats");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} ha pujat a\nNV. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} ha après\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} vol aprendre\n{B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("Però {B_BUFF1} no pot aprendre\nmés de quatre moviments.\p");
static const u8 sText_TryToLearnMove3[] = _("Esborrar un moviment per\nfer lloc a {B_BUFF2}?");
...
static const u8 sText_AttackMissed[] = _("L'atac de {B_ATK_NAME_WITH_PREFIX}\nha fallat!");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\ns'ha protegit!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} ha evitat\nel dany amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} fa que els moviments\nTERRA fallin amb {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} ha evitat\nl'atac!");
static const u8 sText_ItDoesntAffect[] = _("No afecta\n{B_DEF_NAME_WITH_PREFIX}…");
static const u8 sText_AttackerFainted[] = _("{B_ATK_NAME_WITH_PREFIX}\ns'ha debilitat!\p");
static const u8 sText_TargetFainted[] = _("{B_DEF_NAME_WITH_PREFIX}\ns'ha debilitat!\p");
static const u8 sText_PlayerGotMoney[] = _("{B_PLAYER_NAME} ha guanyat ¥{B_BUFF1}\nper la victòria!\p");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} s'ha quedat\nsense POKéMON!\p");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} s'ha esvaït!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} impedeix\nla fugida amb {B_SCR_ACTIVE_ABILITY}!\p");
static const u8 sText_CantEscape2[] = _("No pots escapar!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} no pot escapar!");
static const u8 sText_HitXTimes[] = _("Ha impactat {B_BUFF1} cop(s)!");
...
static const u8 sText_PkmnHurtByPoison[] = _("{B_ATK_NAME_WITH_PREFIX} ha rebut dany\npel verí!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} ja\nestà enverinat.");
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} ha estat\ngreument enverinat!");
static const u8 sText_PkmnEnergyDrained[] = _("S'ha drenat l'energia\nde {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnHurtByBurn[] = _("{B_ATK_NAME_WITH_PREFIX} ha rebut dany\nper la cremada!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} ja\ntenia una cremada.");
static const u8 sText_PkmnWasFrozen[] = _("{B_EFF_NAME_WITH_PREFIX} ha estat\ncongelat!");
...
static const u8 sText_PkmnWasDefrostedBy[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\ndescongelat amb {B_CURRENT_MOVE}!");
static const u8 sText_PkmnWasParalyzed[] = _("{B_EFF_NAME_WITH_PREFIX} està paralitzat!\nPotser no es pugui moure!");
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_ABILITY} de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nha paralitzat {B_EFF_NAME_WITH_PREFIX}!\lPotser no es pugui moure!");
static const u8 sText_PkmnIsParalyzed[] = _("{B_ATK_NAME_WITH_PREFIX} està paralitzat!\nNo es pot moure!");
...
static const u8 sText_PkmnDreamEaten[] = _("S'ha menjat el somni\nde {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_FoeStoppedWorking[] = _("{B_BUFF1} de l'enemic\nha deixat de funcionar!");
static const u8 sText_PkmnIsConfused[] = _("{B_ATK_NAME_WITH_PREFIX} està\nconfús!");
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\nrecuperat de la confusió!");
...
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX} està enamorat\nde {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnChangedType[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha transformat\nal tipus {B_BUFF1}!");
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX} ha vacil·lat!");
static const u8 sText_PkmnRegainedHealth[] = _("{B_DEF_NAME_WITH_PREFIX} ha recuperat\nsalut!");
static const u8 sText_PkmnHPFull[] = _("{B_DEF_NAME_WITH_PREFIX} té\nels PS al màxim!");
...
static const u8 sText_PkmnCoveredByVeil[] = _("L'equip de {B_ATK_PREFIX2} ha quedat\ncobert per un vel!");
static const u8 sText_PkmnUsedSafeguard[] = _("L'equip de {B_DEF_NAME_WITH_PREFIX} està protegit\nper SALVAGUARDA!");
static const u8 sText_PkmnSafeguardExpired[] = _("L'equip de {B_ATK_PREFIX3} ja no està\nprotegit per SALVAGUARDA!");
...
static const u8 sText_PkmnDugHole[] = _("{B_ATK_NAME_WITH_PREFIX} ha excavat un forat!");
...
static const u8 sText_PkmnSqueezedByBind[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat atrapat\nper l'ATADURA de {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnTrappedInVortex[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat atrapat\nal vòrtex!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat atrapat\nper TOMBA SORRA!");
static const u8 sText_PkmnWrappedBy[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat EMBOLICAT\nper {B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnClamped[] = _("{B_ATK_NAME_WITH_PREFIX} ha TANCAT\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnHurtBy[] = _("{B_ATK_NAME_WITH_PREFIX} ha rebut dany\nde {B_BUFF1}!");
static const u8 sText_PkmnFreedFrom[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha alliberat\nde {B_BUFF1}!");
...
static const u8 sText_PkmnProtectedByMist[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} està protegit\nper la BOIRA!");
...
static const u8 sText_PkmnProtectedItself2[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\nprotegit!");
static const u8 sText_PkmnBuffetedBySandstorm[] = _("{B_ATK_NAME_WITH_PREFIX} rep cops\nde la tempesta de sorra!");
static const u8 sText_PkmnPeltedByHail[] = _("{B_ATK_NAME_WITH_PREFIX} rep cops\nde la CALAMARSA!");
...
static const u8 sText_PkmnUproarKeptAwake[] = _("Però l'ENRENOU de {B_SCR_ACTIVE_NAME_WITH_PREFIX}\nl'ha mantingut despert!");
static const u8 sText_PkmnWokeUpInUproar[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha despertat\nper l'ENRENOU!");
...
static const u8 sText_PkmnStockpiled[] = _("{B_ATK_NAME_WITH_PREFIX} ha RESERVAT\n{B_BUFF1}!");
...
static const u8 sText_PkmnStayedAwakeUsing[] = _("{B_DEF_NAME_WITH_PREFIX} ha quedat despert\ngràcies a {B_DEF_ABILITY}!");
static const u8 sText_PkmnStoringEnergy[] = _("{B_ATK_NAME_WITH_PREFIX} està emmagatzemant\nenergia!");
...
static const u8 sText_PkmnUnaffected[] = _("{B_DEF_NAME_WITH_PREFIX} no s'ha\nvist afectat!");
static const u8 sText_PkmnTransformedInto[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha transformat\nen {B_BUFF1}!");
...
static const u8 sText_PkmnSubstituteFaded[] = _("El SUBSTITUT de {B_DEF_NAME_WITH_PREFIX}\nha desaparegut!\p");
static const u8 sText_PkmnMustRecharge[] = _("{B_ATK_NAME_WITH_PREFIX} ha de\nrecarregar!");
static const u8 sText_PkmnRageBuilding[] = _("La IRA de {B_DEF_NAME_WITH_PREFIX}\ns'està acumulant!");
...
static const u8 sText_PkmnEncoreEnded[] = _("L'ÀNCORE de {B_ATK_NAME_WITH_PREFIX}\nha acabat!");
...
static const u8 sText_PkmnTryingToTakeFoe[] = _("{B_ATK_NAME_WITH_PREFIX} vol emportar-se\nl'enemic amb ell!");
static const u8 sText_PkmnTookFoe[] = _("{B_DEF_NAME_WITH_PREFIX} s'ha emportat\n{B_ATK_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnReducedPP[] = _("S'ha reduït {B_BUFF1} de\n{B_DEF_NAME_WITH_PREFIX} en {B_BUFF2}!");
static const u8 sText_PkmnStoleItem[] = _("{B_ATK_NAME_WITH_PREFIX} ha robat\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_TargetCantEscapeNow[] = _("{B_DEF_NAME_WITH_PREFIX} ja no pot\nescapar!");
...
static const u8 sText_PkmnLaidCurse[] = _("{B_ATK_NAME_WITH_PREFIX} ha retallat els seus PS\ni ha llançat una MALEDICCIÓ a {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnAfflictedByCurse[] = _("{B_ATK_NAME_WITH_PREFIX} pateix\nla MALEDICCIÓ!");
static const u8 sText_SpikesScattered[] = _("S'han escampat PÚES per tot\nel costat de l'oponent!");
static const u8 sText_PkmnHurtBySpikes[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha rebut\ndany de les PÚES!");
static const u8 sText_PkmnIdentified[] = _("{B_ATK_NAME_WITH_PREFIX} ha identificat\n{B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnPerishCountFell[] = _("El compte CONDEMNA de {B_ATK_NAME_WITH_PREFIX}\nha baixat a {B_BUFF1}!");
...
static const u8 sText_PkmnCutHPMaxedAttack[] = _("{B_ATK_NAME_WITH_PREFIX} ha retallat els seus PS\ni ha maximitzat l'ATAC!");
static const u8 sText_PkmnCopiedStatChanges[] = _("{B_ATK_NAME_WITH_PREFIX} ha copiat\nels canvis d'estad. de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnGotFree[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha alliberat\nde {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnShedLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX} ha descartat\nDRENAVIDES!");
...
static const u8 sText_PkmnChoseXAsDestiny[] = _("{B_ATK_NAME_WITH_PREFIX} ha escollit\n{B_CURRENT_MOVE} com a destí!");
static const u8 sText_PkmnAttack[] = _("Atac de {B_BUFF1}!");
static const u8 sText_PkmnCenterAttention[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha convertit\nen el centre d'atenció!");
static const u8 sText_PkmnChargingPower[] = _("{B_ATK_NAME_WITH_PREFIX} ha començat\na carregar poder!");
static const u8 sText_NaturePowerTurnedInto[] = _("PODER NATURAL s'ha convertit\nen {B_CURRENT_MOVE}!");
static const u8 sText_PkmnStatusNormal[] = _("L'estat de {B_ATK_NAME_WITH_PREFIX}\nha tornat a la normalitat!");
static const u8 sText_PkmnSubjectedToTorment[] = _("{B_DEF_NAME_WITH_PREFIX} ha estat sotmès\na TURMENT!");
static const u8 sText_PkmnTighteningFocus[] = _("{B_ATK_NAME_WITH_PREFIX} està concentrant\nla seva atenció!");
static const u8 sText_PkmnFellForTaunt[] = _("{B_DEF_NAME_WITH_PREFIX} ha caigut\nen la MOFA!");
static const u8 sText_PkmnReadyToHelp[] = _("{B_ATK_NAME_WITH_PREFIX} està preparat per\najudar {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwitchedItems[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nobjectes amb l'oponent!");
...
static const u8 sText_PkmnWasMadeDrowsy[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet\nque {B_DEF_NAME_WITH_PREFIX} tingués son!");
static const u8 sText_PkmnKnockedOff[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet caure\n{B_LAST_ITEM} de {B_DEF_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnSwappedAbilities[] = _("{B_ATK_NAME_WITH_PREFIX} ha intercanviat\nhabilitats amb l'oponent!");
static const u8 sText_PkmnSealedOpponentMove[] = _("{B_ATK_NAME_WITH_PREFIX} ha segellat\nel(s) moviment(s) de l'oponent!");
static const u8 sText_PkmnWantsGrudge[] = _("{B_ATK_NAME_WITH_PREFIX} vol que l'oponent\nguardi RANCOR!");
static const u8 sText_PkmnLostPPGrudge[] = _("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} ha perdut\ntots els PP pel RANCOR!");
static const u8 sText_PkmnShroudedItself[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha\nenvoltat de {B_CURRENT_MOVE}!");
static const u8 sText_PkmnMoveBounced[] = _("{B_CURRENT_MOVE} de {B_ATK_NAME_WITH_PREFIX}\nha rebotat amb CAPA MÀGICA!");
static const u8 sText_PkmnWaitsForTarget[] = _("{B_ATK_NAME_WITH_PREFIX} espera que\nun objectiu faci un moviment!");
static const u8 sText_PkmnSnatchedMove[] = _("{B_DEF_NAME_WITH_PREFIX} ha ROBAT\nel moviment de {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
...
static const u8 sText_SoothingAroma[] = _("Una aroma relaxant\nha impregnat la zona!");
static const u8 sText_ItemsCantBeUsedNow[] = _("Ara no es poden usar objectes.{PAUSE 64}");
static const u8 sText_ForXCommaYZ[] = _("Per a {B_SCR_ACTIVE_NAME_WITH_PREFIX},\n{B_LAST_ITEM} {B_BUFF1}");
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha usat\n{B_LAST_ITEM} per motivar-se!");
...
static const u8 sText_PkmnRestoredHPUsing[] = _("{B_DEF_NAME_WITH_PREFIX} ha recuperat PS\nusant {B_DEF_ABILITY}!");
static const u8 sText_PkmnsXMadeYUseless[] = _("{B_DEF_ABILITY} de {B_DEF_NAME_WITH_PREFIX}\nha fet {B_CURRENT_MOVE} inútil!");
...
const u8 gText_DefendersStatRose[] = _("El/La {B_BUFF1} de {B_DEF_NAME_WITH_PREFIX}\n{B_BUFF2}$");
static const u8 sText_UsingItemTheStatOfPkmnRose[] = _("Usant {B_LAST_ITEM}, {B_BUFF1}\nde {B_SCR_ACTIVE_NAME_WITH_PREFIX} {B_BUFF2}");
...
static const u8 sText_StatsWontIncrease2[] = _("Les estad. de {B_ATK_NAME_WITH_PREFIX}\nno pujaran més!");
static const u8 sText_StatsWontDecrease2[] = _("Les estad. de {B_DEF_NAME_WITH_PREFIX}\nno baixaran més!");
...
static const u8 sText_HMMovesCantBeForgotten[] = _("Els moviments de MO no es poden\noblidar ara.\p");
static const u8 sText_NotVeryEffective[] = _("No és gaire efectiu…");
static const u8 sText_SuperEffective[] = _("És superefectiu!");
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Has escapat sense problemes!\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} ha fugit\nusant {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} ha fugit\nusant {B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE SE_FLEE}El {B_BUFF1} salvatge ha fugit!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("El jugador ha derrotat\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("El jugador ha vençut {B_LINK_OPPONENT1_NAME}\ni {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("El jugador ha perdut contra\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerLostToTwo[] = _("El jugador ha perdut contra {B_LINK_OPPONENT1_NAME}\ni {B_LINK_OPPONENT2_NAME}!");
...
static const u8 sText_NoRunningFromTrainers[] = _("No! No pots fugir d'un combat\ncontra un ENTRENADOR!\p");
static const u8 sText_CantEscape[] = _("No pots escapar!\p");
static const u8 sText_DontLeaveBirch[] = _("PROF. BEDOLL: No em deixis així!\p");
static const u8 sText_ButNothingHappened[] = _("Però no ha passat res!");
static const u8 sText_ButItFailed[] = _("Però ha fallat!");
static const u8 sText_ItHurtConfusion[] = _("S'ha ferit a si mateix\nen la confusió!");
...
static const u8 sText_SandstormRages[] = _("La tempesta de sorra es desfermada.");
...
static const u8 sText_SunlightFaded[] = _("La llum del sol s'ha esvaït.");
...
static const u8 sText_FailedToSpitUp[] = _("Però no ha pogut ESCUPIR\nres!");
static const u8 sText_FailedToSwallow[] = _("Però no ha pogut ENGOLIR\nres!");
static const u8 sText_WindBecameHeatWave[] = _("El vent s'ha convertit en una\nONA DE CALOR!");
static const u8 sText_StatChangesGone[] = _("Tots els canvis d'estad.\nhan estat eliminats!");
static const u8 sText_CoinsScattered[] = _("Les monedes s'han escampat pertot!");
static const u8 sText_TooWeakForSubstitute[] = _("Era massa feble per crear\nun SUBSTITUT!");
static const u8 sText_SharedPain[] = _("Els combatents han compartit\nel seu dolor!");
static const u8 sText_BellChimed[] = _("Una campana ha sonat!");
static const u8 sText_FaintInThree[] = _("Tots els POKéMON afectats\nes debilitaran en tres torns!");
static const u8 sText_NoPPLeft[] = _("No queden PP per aquest\nmoviment!\p");
static const u8 sText_ButNoPPLeft[] = _("Però no quedaven PP\nper al moviment!");
static const u8 sText_PkmnIgnoresAsleep[] = _("{B_ATK_NAME_WITH_PREFIX} ha ignorat\nles ordres mentre dormia!");
static const u8 sText_PkmnIgnoredOrders[] = _("{B_ATK_NAME_WITH_PREFIX} ha ignorat\nles ordres!");
static const u8 sText_PkmnBeganToNap[] = _("{B_ATK_NAME_WITH_PREFIX} ha començat a dormitar!");
...
static const u8 sText_PkmnTurnedAway[] = _("{B_ATK_NAME_WITH_PREFIX} s'ha girat!");
static const u8 sText_PkmnPretendNotNotice[] = _("{B_ATK_NAME_WITH_PREFIX} ha fet\nveure que no se n'adonava!");
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} és\na punt d'usar {B_BUFF2}.\pVol {B_PLAYER_NAME} canviar\nde POKéMON?");
...
static const u8 sText_CreptCloser[] = _("{B_PLAYER_NAME} s'ha apropat sigilosament\na {B_OPPONENT_MON1_NAME}!");
static const u8 sText_CantGetCloser[] = _("{B_PLAYER_NAME} no pot apropar-se més!");
static const u8 sText_PkmnWatchingCarefully[] = _("{B_OPPONENT_MON1_NAME} està mirant\natentament!");
static const u8 sText_PkmnCuriousAboutX[] = _("{B_OPPONENT_MON1_NAME} sent curiositat\nper {B_BUFF1}!");
static const u8 sText_PkmnEnthralledByX[] = _("{B_OPPONENT_MON1_NAME} està captivat\nper {B_BUFF1}!");
...
static const u8 sText_WildPkmnAppeared[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME} salvatge!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME} salvatge!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("Ha aparegut un {B_OPPONENT_MON1_NAME} salvatge!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("Han aparegut un {B_OPPONENT_MON1_NAME} i\nun {B_OPPONENT_MON2_NAME} salvatges!\p");
...
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha tret\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha tret\n{B_OPPONENT_MON1_NAME} i {B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha tret\n{B_BUFF1}!");
static const u8 sText_LinkTrainerSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha tret\n{B_OPPONENT_MON1_NAME}!");
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha tret\n{B_OPPONENT_MON1_NAME} i {B_OPPONENT_MON2_NAME}!");
static const u8 sText_TwoLinkTrainersSentOutPkmn[] = _("{B_LINK_OPPONENT1_NAME} ha tret {B_LINK_OPPONENT_MON1_NAME}!\n{B_LINK_OPPONENT2_NAME} ha tret {B_LINK_OPPONENT_MON2_NAME}!");
static const u8 sText_LinkTrainerSentOutPkmn2[] = _("{B_LINK_OPPONENT1_NAME} ha tret\n{B_BUFF1}!");
static const u8 sText_LinkTrainerMultiSentOutPkmn[] = _("{B_LINK_SCR_TRAINER_NAME} ha tret\n{B_BUFF1}!");
static const u8 sText_GoPkmn[] = _("Endavant, {B_PLAYER_MON1_NAME}!");
static const u8 sText_GoTwoPkmn[] = _("Endavant, {B_PLAYER_MON1_NAME} i\n{B_PLAYER_MON2_NAME}!");
static const u8 sText_GoPkmn2[] = _("Endavant, {B_BUFF1}!");
static const u8 sText_DoItPkmn[] = _("Fes-ho, {B_BUFF1}!");
static const u8 sText_GoForItPkmn[] = _("Ànims, {B_BUFF1}!");
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("L'enemic és feble!\nAtaca'l, {B_BUFF1}!");
static const u8 sText_LinkPartnerSentOutPkmnGoPkmn[] = _("{B_LINK_PARTNER_NAME} ha tret {B_LINK_PLAYER_MON2_NAME}!\nEndavant, {B_LINK_PLAYER_MON1_NAME}!");
static const u8 sText_PkmnThatsEnough[] = _("{B_BUFF1}, ja n'hi ha prou!\nTorna!");
static const u8 sText_PkmnComeBack[] = _("{B_BUFF1}, torna!");
static const u8 sText_PkmnOkComeBack[] = _("{B_BUFF1}, molt bé!\nTorna!");
static const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, genial!\nTorna!");
...
static const u8 sText_FoePkmnPrefix[] = _("Enemic ");
static const u8 sText_EmptyString8[] = _("");
static const u8 sText_FoePkmnPrefix2[] = _("Enemic");
static const u8 sText_AllyPkmnPrefix[] = _("Aliat");
static const u8 sText_FoePkmnPrefix3[] = _("Enemic");
static const u8 sText_AllyPkmnPrefix2[] = _("Aliat");
static const u8 sText_FoePkmnPrefix4[] = _("Enemic");
...
static const u8 sText_WallyUsedItem[] = _("BLASI ha usat\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME}\nha usat {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("L'ENTRENADOR ha blocat la BALL!");
static const u8 sText_DontBeAThief[] = _("No siguis un lladre!");
static const u8 sText_ItDodgedBall[] = _("Ha esquivat la BALL!\nAquest POKéMON no es pot atrapar!");
static const u8 sText_YouMissedPkmn[] = _("Has fallat el POKéMON!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nEl POKéMON s'ha alliberat!");
static const u8 sText_ItAppearedCaught[] = _("Oh!\nSemblava que l'havies atrapat!");
static const u8 sText_AarghAlmostHadIt[] = _("Argh!\nQuasi l'havies atrapat!");
static const u8 sText_ShootSoClose[] = _("Ostres!\nHa estat molt a prop!");
static const u8 sText_GotchaPkmnCaughtPlayer[] = _("T'he enxampat!\nHas atrapat {B_OPPONENT_MON1_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaughtWally[] = _("T'he enxampat!\nHas atrapat {B_OPPONENT_MON1_NAME}!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("Vols posar un malnom\nal {B_OPPONENT_MON1_NAME} capturat?");
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME} ha estat enviat\na l'ordinador de {B_PC_CREATOR_NAME}.");
static const u8 sText_Someones[] = _("algú");
static const u8 sText_Lanettes[] = _("MAITE");
...
static const u8 sText_BoxIsFull[] = _("La CAPSA és plena!\nNo pots atrapar'n més!\p");
...
const u8 gText_WhatWillWallyDo[] = _("Què farà\nen BLAI?$");
const u8 gText_LinkStandby[] = _("{PAUSE 16}Esperant connexió…");
const u8 gText_BattleMenu[] = _("LLUITAR{CLEAR_TO 56}MOTXILLA\nPOKéMON{CLEAR_TO 56}FUGIR$");
const u8 gText_SafariZoneMenu[] = _("BOLA{CLEAR_TO 56}{POKEBLOCK}\nAPROPAR{CLEAR_TO 56}FUGIR$");
...
const u8 gText_SafariBallLeft[] = _("{HIGHLIGHT DARK_GRAY}Resten: $" "{HIGHLIGHT DARK_GRAY}");
...
const u8 gText_BattleWallyName[] = _("BLASI");
const u8 gText_Win[] = _("{HIGHLIGHT TRANSPARENT}Victòria");
...
const u8 gText_BattleTourney[] = _("TORNEIG COMBAT");
...
const u8 gText_WillChampionshipDreamComeTrue[] = _("Es farà realitat el somni de campionat?!\p");
...
const u8 gText_Judgment[] = _("{B_BUFF1}{CLEAR 13}Judici{CLEAR 13}{B_BUFF2}");
static const u8 sText_TwoTrainersSentPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ha tret\n{B_OPPONENT_MON1_NAME}!\p{B_TRAINER2_CLASS} {B_TRAINER2_NAME} ha tret\n{B_OPPONENT_MON2_NAME}!");
static const u8 sText_Trainer2SentOutPkmn[] = _("{B_TRAINER2_CLASS} {B_TRAINER2_NAME} ha tret\n{B_BUFF1}!");
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} i\n{B_TRAINER2_CLASS} {B_TRAINER2_NAME}\lvolen lluitar!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PARTNER_CLASS} {B_PARTNER_NAME} ha tret\n{B_PLAYER_MON2_NAME}!\lEndavant, {B_PLAYER_MON1_NAME}!");
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} i\n{B_TRAINER2_CLASS} {B_TRAINER2_NAME}\nhan estat derrotats!\p");
static const u8 sText_Trainer2LoseText[] = _("{B_TRAINER2_LOSE_TEXT}");
static const u8 sText_PkmnIncapableOfPower[] = _("{B_ATK_NAME_WITH_PREFIX} sembla incapaç\nd'usar el seu poder!");
static const u8 sText_GlintAppearsInEye[] = _("Un destell apareix als ulls\nde {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnGettingIntoPosition[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} s'està posant\nen posició!");
static const u8 sText_PkmnBeganGrowlingDeeply[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} ha començat a grunyir!");
static const u8 sText_PkmnEagerForMore[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} vol més!");
...
static const u8 sText_RefIfNothingIsDecided[] = _("ÀRBITRE: Si no es decideix res en\n3 torns, passarem al veredicte!");
static const u8 sText_RefThatsIt[] = _("ÀRBITRE: Ja està! Ara passarem al\nveredicte per determinar el guanyador!");
...
static const u8 sText_RefPlayerWon[] = _("ÀRBITRE: Veredicte: {B_BUFF1} a {B_BUFF2}!\nEl guanyador és {B_PLAYER_MON1_NAME} de {B_PLAYER_NAME}!\p");
static const u8 sText_RefOpponentWon[] = _("ÀRBITRE: Veredicte: {B_BUFF1} a {B_BUFF2}!\nEl guanyador és {B_OPPONENT_MON1_NAME} de {B_TRAINER1_NAME}!\p");
static const u8 sText_RefDraw[] = _("ÀRBITRE: Veredicte: 3 a 3!\nTenim un empat!\p");
static const u8 sText_DefeatedOpponentByReferee[] = _("{B_PLAYER_MON1_NAME} ha derrotat l'oponent\n{B_OPPONENT_MON1_NAME} per decisió de l'ÀRBITRE!");
static const u8 sText_LostToOpponentByReferee[] = _("{B_PLAYER_MON1_NAME} ha perdut contra l'oponent\n{B_OPPONENT_MON1_NAME} per decisió de l'ÀRBITRE!");
static const u8 sText_TiedOpponentByReferee[] = _("{B_PLAYER_MON1_NAME} ha empatat amb l'oponent\n{B_OPPONENT_MON1_NAME} per decisió de l'ÀRBITRE!");
...
const u8 gText_RecordBattleToPass[] = _("Vols gravar el combat\nal PASSI FRONTERA?$");
const u8 gText_BattleRecordedOnPass[] = _("El resultat del combat de {B_PLAYER_NAME}\ns'ha gravat al PASSI FRONTERA.$");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{B_LINK_OPPONENT1_NAME}\nvol lluitar!{PAUSE 49}");
static const u8 sText_TwoLinkTrainersWantToBattlePause[] = _("{B_LINK_OPPONENT1_NAME} i {B_LINK_OPPONENT2_NAME}\nvolen lluitar!{PAUSE 49}");
